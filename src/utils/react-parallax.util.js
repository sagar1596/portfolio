...
export default class extends React.Component {
    ...
    update = () => {
        ...
        this.space = this._container.current[horizontal ? 'clientWidth' : 'clientHeight']
        if (scrolling) this.current = this._container.current[horizontal ? 'scrollLeft' : 'scrollTop']
        else this._container.current[horizontal ? 'scrollLeft' : 'scrollTop'] = this.current = this.offset * this.space
        if (this._content.current)
        this._content.current.style[horizontal ? 'width' : 'height'] = `${this.space * this.props.pages}px`
    ...
    scrollTo(offset) {
        ...
        this.scrollStop()
        this.offset = offset
        const target = this._container.current
